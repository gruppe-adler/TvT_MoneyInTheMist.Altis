...
",round ((["trackingInterval",0] call mitm_common_fnc_getMissionConfigEntry)/60),1/(["trackingIntervalFactorNoCourier",0] call mitm_common_fnc_getMissionConfigEntry),1/(["trackingIntervalFactorVehicle",0] call mitm_common_fnc_getMissionConfigEntry)];
